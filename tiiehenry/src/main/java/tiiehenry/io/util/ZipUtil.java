...
import tiiehenry.io.FileExistsException;
import java.util.Enumeration;
import tiiehenry.io.util.ZipUtil.OnUpdateListener;
...
public class ZipUtil {
  ...
  public void unZip(ArrayMap<String,File> files) throws IOException, FileExistsException {
	...
	try {
	  unZip(zis, files);
	} catch (FileExistsException|FileNotFoundException|IOException e) {
	  throw e;
	} finally {
	  if (zis != null) {
		try {
